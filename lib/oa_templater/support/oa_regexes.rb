module OaTemplater
  ...
  R_HEADER_REASONS = '(?:^.{0,2}理\p{Z}*由\p{Z}*\p{N}*\p{Z}*(?:（(?:特許[^\)）\nに引性]*|新規性|サポート要件|拡大先願|進歩性|実施可能要件|発明の単一性|明確性)）)(?:(?:及び|、)  .{0,2}理\p{Z}*>由\p{Z}*\p{N}+\p{Z}*(?:（(?:新規性|拡大先願|サポート要件|進歩性|実施可能要件|発明の単一性|明確性)）))*(?:(?:及び|、)  .{0,2}理\p{Z}*由\p{Z}*\p{N}+\p{Z}*(?:（(?:新規性|拡大 先願|サポート要件|進歩性|実施可能要件|発明の単一性|明確性)）))* | (?:.{0,2}理\p{Z}*由\p{Z}*\p{N}{0,2}\p{Z}*（特許法第?\p{N}{0,2}条第?\p{N}{0,2}項）)(?:について)    )'
  R_HEADER_TYPES = /(
                       #{R_HEADER_REASONS}
                     | (?:^\s*$)
